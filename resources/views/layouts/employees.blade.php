                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-xs-6 text-right">
                                <a class="btn btn-success event-link btn-plus" data-remote="true" href="/employees/new" data-action="open-modal"><span class="visible-xs">
                            ...
                            <div class="col-sm-12">
                                <div class="table-responsive">
                                    <table class="table table-hover table-ui-sortable">
                                        ...
                                        <tr class="clickable-row employee" data-type="update" data-link="/employees/update_form/{{$staffItem['id']}}" data-id="{{$staffItem['id']}}" data-remote="true" id="block_{{$staffItem['id']}}">
                                            ...
                                            <td style="width: 308px;">
                                                <span class="components-Inventory-components-Products-ProductPrice___full-price___1cwfp">
                                                    <a href="/employees/inventory/show/{{$staffItem['id']}}">Просмотреть инвентарь</a>
                                                </span>
                                            </td>
                                        </tr>
                                        @endforeach
            ...
            <div class="components-Modal-Modal___container___3mETe components-Modal-Modal___large___28vxo">
                <div class="components-Loader-Loader___self___sERCy">
                    <div class="components-Loader-Loader___children___1nSg3">
                        <div class="components-Modal-Header___self___3YXP4">Новый сотрудник</div>
                                            ...
                                            <div class="components-Form-FormField___self___10VZD">
                                                ...
                                                <div class="components-Input-Input___self___2cl9W">
                                                    <div class="components-Input-Input___container___2dCSs">
                                                        <input type="text" name="name" class="components-Input-Input___input___1fuFB" placeholder="например Иващенко Наталья">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="components-Form-FormGroup___flex___3Lzrh">
                                                    <div class="components-Form-FormGroupCol___self___2sGrM">
                                                        ...
                                                        <div class="components-Form-FormField___self___10VZD">
                                                            ...
                                                            <div class="components-Input-Input___self___2cl9W">
                                                                <div class="components-Input-Input___container___2dCSs">
                                                                    <input type="text" name="phone" class="components-Input-Input___input___1fuFB" placeholder="">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                        ...
                        <div class="components-Modal-Footer___self___1LdZR">
                            <button class="components-Button-Button___btn___2Akmm components-Button-Button___btn-collapse___3GpfG components-Button-Button___btn-success___3ZLjD" data-type="submit" data-target="/employees/new">
                                Сохранить
                            </button>
