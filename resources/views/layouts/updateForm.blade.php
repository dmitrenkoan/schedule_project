<div class="components-Modal-Modal___container___3mETe components-Modal-Modal___large___28vxo">
    <div class="components-Loader-Loader___self___sERCy">
        <div class="components-Loader-Loader___children___1nSg3">
            <div class="components-Modal-Header___self___3YXP4">Редактировать продукт</div>
                        ...
                        <div class="components-Form-FormGroup___flex___3Lzrh">
                            <div class="components-Form-FormGroupCol___self___2sGrM components-Form-FormGroupCol___white-space___1Tn2L">
                                <div class="components-Form-FormField___self___10VZD">
                                    ...
                                    <div class="components-Input-Input___self___2cl9W">
                                        <div class="components-Input-Input___container___2dCSs">
                                            <input type="text" name="name" class="components-Input-Input___input___1fuFB" placeholder="например Шампунь" value="{{$arInventary[0]['name']}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="components-Form-FormField___self___10VZD">
                                    ...
                                    <span class="components-Select-Select___self___13CJj">
                                                                <select name="unit_type_id" required="" class="components-Select-Select___select___1ytQc">
                                                                    ...
                                                                    @foreach($arUnitType as $arUnit)
                                                                        <option value="{{$arUnit->id}}" @if($arUnit->id == $arInventary[0]['unit_type_id']) selected @endif >{{$arUnit->name}}</option>
                                                                    @endforeach
                                                                </select>
                                ...
                                <div class="components-Form-FormField___self___10VZD">
                                    ...
                                    <div class="components-Input-Input___self___2cl9W">
                                        <div class="components-Input-Input___container___2dCSs">
                                            <input type="text" name="quantity" class="components-Input-Input___input___1fuFB" placeholder="" value="{{$arInventary[0]['quantity']}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="components-Form-FormGroup___flex___3Lzrh">
                                        <div class="components-Form-FormGroupCol___self___2sGrM">
                                            ...
                                            <div class="components-Form-FormField___self___10VZD">
                                                ...
                                                <div class="components-Input-Input___self___2cl9W">
                                                    <div class="components-Input-Input___container___2dCSs">
                                                        <input type="text" name="unit_price" class="components-Input-Input___input___1fuFB" placeholder="" value="{{$arInventary[0]['unit_price']}}">
                                                    </div>
                                                </div>
                                            </div>
            ...
            <div class="components-Modal-Footer___self___1LdZR">
                <button class="components-Button-Button___btn___2Akmm components-Button-Button___btn-collapse___3GpfG components-Button-Button___btn-success___3ZLjD" data-type="update_submit" data-target="/inventory/products/update/{{$arInventary[0]['id']}}" data-insert="block_{{$arInventary[0]['id']}}">
                    Сохранить
                </button>
