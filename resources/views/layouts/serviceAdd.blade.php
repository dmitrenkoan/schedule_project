<li class="b-b b-grey bg-white service" id="service_{{$obServices->id}}" data-type="update" data-link="/services/update_form/{{$obServices->id}}">
            ...
            <div class="media-body media-middle">
                ...
                <div class="col-sm-3 col-md-3 col-lg-3">
                    <a class="service__name event-link"   >
                        @if(!empty($arStaff))
                            @foreach($arStaff as $key => $serviceStaffItem)
