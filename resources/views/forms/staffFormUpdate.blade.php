<div class="components-Modal-Modal___container___3mETe components-Modal-Modal___large___28vxo">
    <div class="components-Loader-Loader___self___sERCy">
        <div class="components-Loader-Loader___children___1nSg3">
            <div class="components-Modal-Header___self___3YXP4">Редактировать сотрудника</div>
                                ...
                                <div class="components-Form-FormField___self___10VZD">
                                    ...
                                    <div class="components-Input-Input___self___2cl9W">
                                        <div class="components-Input-Input___container___2dCSs">
                                            <input type="text" name="name" class="components-Input-Input___input___1fuFB" placeholder="например Иванов Иван" value="{{$arStaff[0]['name']}}">
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="modal-footer">
                <button class="components-Button-Button___btn___2Akmm components-Button-Button___btn-collapse___3GpfG components-Button-Button___btn-success___3ZLjD" data-type="update_submit" data-target="/employees/update/{{$arStaff[0]['id']}}" data-insert="block_{{$arStaff[0]['id']}}">
                    Сохранить
                </button>
                ...
                <div class="pull-left">
                    <a class="btn btn-danger" data-target="/employees/delete/{{$arStaff[0]['id']}}" data-type="delete" data-insert="block_{{$arStaff[0]['id']}}">Удалить</a>
                </div>
