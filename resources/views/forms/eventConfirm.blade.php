...
<div class="components-Modal-Modal___container___3mETe components-Modal-Modal___large___28vxo">
    <div class="components-Loader-Loader___self___sERCy">
        <div class="components-Loader-Loader___children___1nSg3">
            <div class="components-Modal-Header___self___3YXP4">Подтвердить событие</div>
                            ...
                            <div class="components-Form-FormGroupCol___self___2sGrM components-Form-FormGroupCol___white-space___1Tn2L" >
                                ...
                                <div id="add_discount" style="display:none">
                                    <div class="components-Form-FormField___self___10VZD">
                                            ...
                                            <label class="components-Form-FormField___label___1NQ5t">Стоимость услуги</label>
                                            <div class="components-Input-Input___self___2cl9W">
                                                <div class="components-Input-Input___container___2dCSs">
                                                    <input type="text" name="service_cost" class="components-Input-Input___input___1fuFB"  value="{{$obService->price}}" disabled="disabled">
                                                </div>
                                            </div>

                                    </div>
                                    <div class="components-Form-FormField___self___10VZD" id="choose_client" >

                                            <label class="components-Form-FormField___label___1NQ5t">Размер скидки</label>
                                            <div class="components-Input-Input___self___2cl9W">
                                                <div class="components-Input-Input___container___2dCSs">
                                                    <input type="text" name="discount_value" class="components-Input-Input___input___1fuFB"  value="">
                                                </div>
                                            </div>
                                    ...
                                    <div class="components-Form-FormField___self___10VZD" style="height:200px;">
                                        <label class="components-Form-FormField___label___1NQ5t" for="customer_text">Причина скидки</label>
                                        <div class="components-Input-Input___self___2cl9W">
                                            <div class="components-Input-Input___container___2dCSs">
                                                <textarea rows="5" class="text optional form-control" placeholder="Добавьте причину предоставления скидки" name="discount_note" id="customer_text"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="modal-footer">
                <button class="components-Button-Button___btn___2Akmm components-Button-Button___btn-collapse___3GpfG components-Button-Button___btn-success___3ZLjD" data-type="update_submit" data-target="/calendar/event/confirm/{{$obCalendar->id}}" data-insert="" data-action="сalendarEventConfirm" >
                    Подтвердить
                </button>
